...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        previous : $('<a>'+options.labelPrevious+'</a>').attr({"href":"#", "id":"btn_prev"}).addClass("btn btn-primary"),
        next : $('<a>'+options.labelNext+'</a>').attr({"href":"#", "id":"btn_next"}).addClass("btn btn-success"),
        finish  : $('<a>'+options.labelFinish+'</a>').attr({"href":"#", "id":"btn_finish"}).addClass("btn btn-default")
    };
