...
<body class="nav-md">
  ...
  <div class="container body">
    ...
    <div class="main_container">
      ...
      <!-- Navigation bar left -->
      <?php include("clientenav_left.php"); ?>
      <!-- /Navigation bar left -->

      <!-- Navigation bar top -->
      <?php include("clientenav_top.php"); ?>
      <!-- /Navigation bar top -->
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2 id="headerClientes"></h2>
                  <ul class="nav navbar-right panel_toolbox">
                  </ul>
                  <div class="clearfix"></div>
                </div>
               
                <div id="contenidoWeb" class="x_content table-responsive"></div>
        ...
        <div class="modal-body" style="overflow: auto;">
          ...
          <div class="row">
            <div class="col-md-6" align="center">
              <button id="imprimirRol" class="btn btn-default">
                <span class="glyphicon glyphicon-print"></span>
                &nbsp;Imprimir Informe</button>
            </div>
            <div class="col-md-6" align="center">
              <button id="cerrarRol" class="btn btn-danger">
  ...
  <!-- MODAL ZONAS SUCURSALES-->
  <div class="modal fade bs-example-modal-lg" id="zonasSucs" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="zonasTitulo"></h4>
        </div>
        <div class="modal-body" id="zonasMapa" style="overflow: auto; height: 450px;"></div>
        <div class="modal-footer">
          <button type="button" id="" class="btn btn-warning col-md-5 a-la-der" data-dismiss="modal">Cerrar</button>
        </div>
  ...
  <!-- MODAL FECHA - INICIO TRABAJO -->
  <div class="modal fade" tabindex="-1" role="dialog" id="modalPeriodo">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4  id="tituloPeriodo" class="modal-title"></h4>
        </div>
        <div id="cuerpoPeriodo" class="modal-body"></div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
          <button id="guardarPeriodo" type="button" class="btn btn-primary">Guardar Config.</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <script src="js/formCliente.js" type="text/javascript"></script>
