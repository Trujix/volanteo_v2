	...
	Class Main{
		...
		*/
		...
		public function enviarMail($mailTo, $nameTo, $cuerpo, $subject, $copia){
		    ...
		    mail($mailTo, utf8_decode("Información de Usuario"), utf8_decode($cuerpo), $headers);
		}
		...
		public function mailCliente($mailTo, $nameTo, $cuerpo, $subject, $copia){
		    ...
		    $headers  = 'MIME-Version: 1.0'."\r\n";
		    $headers .= 'Content-type: text/html; charset=iso-8859-1'."\r\n";
		    $headers .= 'From: Grupo Publicitario Heraldos <adm.heraldos@gmail.com>'."\r\n";
		    
		    if(count($copia) > 0){
		    	$headers .= 'Bcc: ';
		    	for($c = 0; $c < count($copia); $c++){
		    		if($c > 0){
		    			$headers .= ',';
		    		}
		    		$headers .= $copia[$c];
		...
		public function correoPass($correo, $nombre, $pass){
		    ...
		    mail($correo, utf8_decode("Información de Usuario"), utf8_decode($msg), $headers);
		}
		...
		public function correoProveedor($correo, $nombre, $idTrab, $sucursal){
		    ...
		    mail($correo, utf8_decode("Configurar Propuesta"), utf8_decode($msg), $headers);
		}
		...
		public function correoReenvio($correo, $nombre, $idTrab, $sucursal, $tipo, $correos){
		    ...
		    mail($correo, utf8_decode("Reenvío de información"), utf8_decode($msg), $headers);
		}
		...
		public function resetPass($correo, $nombre, $pass){
		    ...
		    mail($correo, utf8_decode("Cambio de Contraseña"), utf8_decode($msg), $headers);
		}
