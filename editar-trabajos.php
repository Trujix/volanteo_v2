...
<body class="nav-md">
  ...
  <!-- MODAL CLIENTES-->
  <div class="modal fade bs-example-modal-lg" id="modalClientes" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
          ...
          <form class="form-horizontal form-label-left input_mask" id="formNuevo">
            ...
            <div class="col-md-12 no-pading">
              <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                ...
                <input class="form-control" id="txt_nombre" name="txt_nombre" placeholder="Ej. Miguel Angel" type="text">
                
              </div>

              <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                <label for="">RFC</label><span style="color: red;">*</span>
                <input class="form-control" id="txt_rfc" name="txt_rfc" placeholder="Ej. TOMA280382HMXRPN01" type="text">
            ...
            <div class="col-md-12 no-pading">
              <div class="col-md-8 col-sm-8 col-xs-12 form-group has-feedback">
                ...
                <input class="form-control" id="txt_calle" name="txt_calle" placeholder="Ej. Dr. Miguel Galindo" type="text">
                
              </div>

              <div class="col-md-2 col-sm-2 col-xs-12 form-group has-feedback">
                <label for="">No. Ext.</label><span style="color: red;">*</span>
                <input class="form-control" id="txt_noext" name="txt_noext" placeholder="Ej. 223" type="text">
              ...
              <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                ...
                <input class="form-control" id="txt_colonia" name="txt_colonia" placeholder="Ej. Centro" type="text">
                
              </div>

              <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                <label for="">Codigo Postal</label><span style="color: red;">*</span>
                <input class="form-control" id="txt_cp" name="txt_cp" placeholder="Ej. 28000" type="text">
                
              </div>

              <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                <label for="">Pais</label><span style="color: red;">*</span>
                <input class="form-control" id="txt_pais" name="txt_pais" placeholder="Ej. Mexico" type="text" value="México">
                
              </div>

              <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                <label for="">Estado</label><span style="color: red;">*</span>
                <select name="txt_estado" class="form-control" id="txt_estado">
              ...
              <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                ...
                <input class="form-control" id="txt_ciudad" name="txt_ciudad" placeholder="Ej. Colima" type="text">
                
              </div>

              <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                <label for="">Municipio</label><span style="color: red;">*</span>
                <!-- <input class="form-control" id="txt_municipio" name="txt_municipio" placeholder="Ej. Colima" type="text"> -->
                <select name="txt_municipio" class="form-control" id="txt_municipio">
                  <option value="0" selected disabled>Seleccione una opción</option>
                </select>
            ...
            <div class="col-md-12 no-pading">
              <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                ...
                <input class="form-control" id="txt_tel1" name="txt_tel1" placeholder="Ej. 3122437643" type="text">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                ...
                <input class="form-control" id="txt_correo" name="txt_correo" placeholder="Ej. micorreo@midominio.com" type="text">
                
              </div>

              <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                <label for="">Web</label><span style="color: red;">*</span>
        ...
        <div class="modal-footer">
          ...
          <button type="button" id="" class="btn btn-primary btnModalClientes col-md-5 a-la-der">Guardar</button>
        </div>
